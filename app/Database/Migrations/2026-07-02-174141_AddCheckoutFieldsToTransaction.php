...
class AddCheckoutFieldsToTransaction extends Migration
{
    public function up()
    {
        $this->forge->addColumn('transaction', [
            'ppn' => ['type' => 'DOUBLE', 'null' => true, 'after' => 'total_harga'],
            'biaya_admin' => ['type' => 'DOUBLE', 'null' => true, 'after' => 'ppn'],
            'voucher_code' => ['type' => 'VARCHAR', 'constraint' => 20, 'null' => true, 'after' => 'biaya_admin'],
            'diskon_voucher' => ['type' => 'DOUBLE', 'null' => true, 'after' => 'voucher_code'],
        ]);
    }
